...
## [Unreleased]
### Changed
- Client version upgraded on [5.3.14](https://github.com/reportportal/client-java/releases/tag/5.3.14), by @HardNorth

## [5.5.0]
### Changed
- Client version upgraded on [5.3.13](https://github.com/reportportal/client-java/releases/tag/5.3.13), by @HardNorth
