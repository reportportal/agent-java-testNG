...
import static com.epam.reportportal.testng.integration.feature.description.DescriptionFailedTest.*;
...
public class TestDescriptionFailedTest {
	...
	private final String testDescriptionTestAssertErrorMessage = MarkdownUtils.asTwoParts(
			TEST_DESCRIPTION,
			String.format(DESCRIPTION_ERROR_FORMAT, assertionError)
	);
	private final String testDescriptionTestExceptionMessage = MarkdownUtils.asTwoParts(
			TEST_DESCRIPTION,
			String.format(DESCRIPTION_ERROR_FORMAT, noSuchElementException)
	);
	...
	private final String testWithoutDescriptionTestExceptionMessage = String.format(DESCRIPTION_ERROR_FORMAT, noSuchElementException)
			.trim();
